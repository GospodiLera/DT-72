...
464 324174 17624
927 83015 19014
Выходит, что TreeSet хуже всех справляется с добавлением и удалением элемента. Хуже всех в поиске элемента справлется ArrayList, несмотря на то, что
быстрее всех добавляет элемент. HashSet быстрее всех удаляет элемент.
*/
