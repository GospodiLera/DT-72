...
То есть TreeSet заметно уступает по времени добавления и удаления элемента, а ArrayList проигрывает по времени поиска элемента, несмотря на лучший результат по добавлению
HashSet быстрее всех находит и удаляет элемент.*/
